...
function redButterfly() {
  ...
  redButterfly.velocityX = 3+redScore/2;
...
function blueButterfly() {
  ...
  blueButterfly.velocityX = 3+blueScore/2;
...
function greenButterfly() {
  ...
  green.velocityX = 3+greenScore/2;
  green.lifetime = 150;
  green.scale = 0.5;
